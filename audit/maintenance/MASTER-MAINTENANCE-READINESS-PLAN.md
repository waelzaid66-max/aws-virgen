...
| 2 | CI أخضر (Typecheck & build + API tests + ESLint + Mobile) | ✅ | 4 jobs — @ `d15f999`+ بعد إصلاح ESLint |
...
|--------|----------------|-----------|--------|
| **هنا (أساسي)** | `origin` → `waelzaid66-max/-BANCO-CA-OOM-` | `main` @ `d15f999`+ | مزامنة `banco.store-main` عند توفر المسار |
